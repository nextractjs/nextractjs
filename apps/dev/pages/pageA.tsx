...
const PageA = () => {
  return (
    <div className="py-0 px-8">
      <Head>
        <title>PageA | Nextract.js</title>
        <meta name="description" content="PageA on Nextract.js" />
      ...
      <main className="flex h-screen flex-1 flex-col items-center justify-center py-16 px-0">
        ...
        <p className="my-6 text-center text-xl lg:text-2xl">Nextract.js just tracked a pageview on /pageA</p>

        <span className="my-6 flex flex-row flex-wrap justify-center gap-2">
          {['/', '/pageB', '/withSSR'].map((path) => (
